...
btn = [] #Array storing 
numOfBombs = 30 #Number of mines
numOfRows = 16 #Number of rows
numOfCols = 16 #Number of columns
...
win_count = 0
loss_count = 0
MAX_GAMES = 1000  # Maximum number of games to play
games_played = 0  # Games played counter
total_time = 0    # Total time taken
start_time = time.time()  # Start time of the gameplay
...
def restartSweep():
	...
	global games_played, total_time, start_time

	games_played += 1
	if games_played > MAX_GAMES:
		total_time = time.time() - start_time
		print(f"Played {MAX_GAMES} games in {total_time} seconds. Won {win_count}: Lost {loss_count}")
		root.quit()  # Closes the Tkinter window and ends the script
		return
